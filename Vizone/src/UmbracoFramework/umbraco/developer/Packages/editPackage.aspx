...
<asp:Content ContentPlaceHolderID="body" runat="server">
    ...
    <cc2:Pane ID="Pane1" runat="server">
        <cc2:PropertyPanel runat="server" ID="pp_name" Text="Package Name">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator0" runat="server" EnableClientScript="false" ControlToValidate="packageName">*</asp:RequiredFieldValidator>
         </cc2:PropertyPanel>
         ...
         <cc2:PropertyPanel runat="server" ID="pp_url" Text="Package Url">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" EnableClientScript="false" ControlToValidate="packageUrl">*</asp:RequiredFieldValidator>
          </cc2:PropertyPanel>
          ...
          <cc2:PropertyPanel runat="server" ID="pp_version" Text="Package Version">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" EnableClientScript="false" ControlToValidate="packageVersion">*</asp:RequiredFieldValidator>
          </cc2:PropertyPanel>
    ...
    <cc2:Pane ID="Pane1_1" runat="server">
      <cc2:PropertyPanel runat="server" ID="pp_author" Text="Author Name">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" EnableClientScript="false" ControlToValidate="packageAuthorName">*</asp:RequiredFieldValidator>
        </cc2:PropertyPanel>
        <cc2:PropertyPanel runat="server" ID="pp_author_url" Text="Author url">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" EnableClientScript="false" ControlToValidate="packageAuthorUrl">*</asp:RequiredFieldValidator>
        </cc2:PropertyPanel>
    </cc2:Pane>
    <cc2:Pane ID="Pane1_2" runat="server">
      <cc2:PropertyPanel runat="server" ID="pp_licens" Text="License Name:">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" EnableClientScript="false" ControlToValidate="packageLicenseName">*</asp:RequiredFieldValidator>
      </cc2:PropertyPanel>
      <cc2:PropertyPanel runat="server" id="pp_license_url" Text="License url:">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" EnableClientScript="false" ControlToValidate="packageLicenseUrl">*</asp:RequiredFieldValidator>
      </cc2:PropertyPanel>
    </cc2:Pane>
    ...
    <cc2:Pane ID="Pane2" runat="server">
       <cc2:PropertyPanel runat="server" ID="pp_content" Text="Content">
            ...
            <br />
            <asp:CheckBox ID="packageContentSubdirs" runat="server" /> Include all child nodes
       </cc2:PropertyPanel>
    </cc2:Pane>
    ...
    <cc2:Pane id="Pane4" runat="server">
      ...
      <asp:CustomValidator ID="actionsVal" runat="server" OnServerValidate="validateActions" ControlToValidate="tb_actions" ErrorMessage="Actions XML is malformed, either remove the text in the actions field or make sure it is correctly formed XML" />
        ...
        <tr>
          <td class="propertyContent">
            <asp:TextBox ID="tb_actions" TextMode="MultiLine" Rows="14" Width="100%" CssClass="guiInputText" runat="server"></asp:TextBox>
          </td>
        </tr>
      </table>
    </cc2:Pane>
